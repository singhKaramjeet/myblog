<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
         <a href="index.php"> <img style="width:35px; height:35px; margin-right:15px;" src="images\graphica studio logo-02.png" alt="logo"></a>
          <a class="navbar-brand" href="index.php">Graphica Studios</a>
  ...
  ?>
     <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                  ...
                  foreach($submenus as $sn){
                      ?>
                      <li><a class="dropdown-item" href=" <?=$sn['action']?>"><?=$sn['name']?></a></li>
                      <?php
                  }
                  ?>
                </ul>
